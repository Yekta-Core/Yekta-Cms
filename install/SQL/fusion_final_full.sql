...
-- Dumping data for table fusion2.articles: ~1 rows (approximately)
/*!40000 ALTER TABLE `articles` DISABLE KEYS */;
INSERT INTO `articles` (`id`, `headline`, `content`, `timestamp`, `author_id`, `avatar`, `comments`) VALUES
	(1, '{"Persian":"به یکتا سی ام اس خوش آمدید"}', '<p style="text-align: right;">شما با موفقیت نصب یکتا سی ام اس رو پشت سر گذاشتید</p>\n<p style="text-align: right;">شما با وارد شدن به پنل ادمین میتوانید کلیه اطلاعات را ویرایش و پست ارسال نمایید</p>\n<p style="text-align: right;">اگر مشکلی دارید با<a title="انجمن رایگان ساخت گیم سرور وو در ایران" href="http://www.yekta-core.ir"> یکتا کر</a> ارتباط برقرار کنید .</p>\n<p style="text-align: right;">بهترین آرزو ها برای شما</p>\n<p style="text-align: right;">از طرف یکتا سی ام اس</p>', 1344607279, 1, '', -1);
...
-- Dumping structure for table fusion2.changelog
...
-- Dumping data for table fusion2.changelog: ~0 rows (approximately)
...
INSERT INTO `image_slider` VALUES ('2', '{path}slides/2.jpg', '', '', '3');
INSERT INTO `image_slider` VALUES ('3', '{path}slides/3.jpg', '', '', '4');
...
/*!40101 SET NAMES utf8 */;
/*!40014 SET FOREIGN_KEY_CHECKS=0 */;
-- Dumping structure for table fusion2.menu
DROP TABLE IF EXISTS `menu`;
CREATE TABLE `menu` (
	`id` INT(10) NOT NULL AUTO_INCREMENT,
	`name` varchar(50) NOT NULL DEFAULT 'FusionCMS Link',
	`link` VARCHAR(255) NULL DEFAULT '#',
	`side` VARCHAR(255) NULL DEFAULT 'top',
	`rank` INT(11) NOT NULL,
	`specific_rank` TINYINT(1) NOT NULL DEFAULT '0',
	`order` INT(11) NULL DEFAULT NULL,
	PRIMARY KEY (`id`),
	INDEX `FK_menu_ranks` (`rank`),
	CONSTRAINT `FK_menu_ranks` FOREIGN KEY (`rank`) REFERENCES `ranks` (`id`) ON UPDATE NO ACTION ON DELETE NO ACTION
)
...
INSERT INTO `menu` (`id`, `name`, `link`, `side`, `rank`, `specific_rank`, `order`) VALUES
	(1, '{"Persian":"صفحه اصلی"}', 'news', 'top', 1, 0, 1),
	(2, '{"Persian":"ساخت اکانت جدید"}', 'register', 'top', 1, 1, 2),
	(5, '{"Persian":"ورود"}', 'login', 'top', 1, 1, 6),
	(6, '{"Persian":"پنل کاربری"}', 'ucp', 'top', 2, 0, 7),
	(7, '{"Persian":"صفحه اصلی"}', 'news', 'side', 1, 0, 8),
	(8, '{"Persian":"ساخت اکانت جدید"}', 'register', 'side', 1, 1, 9),
	(9, '{"Persian":"آموزش اتصال به سرور"}', 'page/connect', 'side', 1, 0, 19),
	(11, '{"Persian":"ورود"}', 'login', 'side', 1, 1, 13),
	(13, '{"Persian":"کنترل پنل کاربری"}', 'ucp', 'side', 2, 0, 10),
	(16, '{"Persian":"بازیکنان آنلاین"}', 'online', 'top', 1, 0, 5),
	(17, '{"Persian":"نمایش بازیکنان آنلاین"}', 'online', 'side', 1, 0, 17),
	(18, '{"Persian":"آرموری"}', 'armory', 'top', 1, 0, 20),
	(19, '{"Persian":"پیام خصوصی"}', 'messages', 'side', 2, 0, 21),
	(20, '{"Persian":"آپدیت و بروزرسانی"}', 'changelog', 'side', 1, 0, 100),
	(21, '{"Persian":"ورود به کنترل پنل مدیریت"}', 'admin', 'side', 5, 0, 16),
	(100, '{"Persian":"خروج"}', 'logout', 'side', 2, 0, 113),
	(101, '{"Persian":"خروج"}', 'logout', 'top', 2, 0, 113),
	(103, '{"Persian":"انتقال هیرو به اکانت دیگر"}', 'character_transfer', 'side', 1, 0, 102),
	(104, '{"Persian":"شارژ حساب کاربری"}', 'donate', 'side', 1, 0, 18),
	(105, '{"Persian":"پنل رای و امتیاز"}', 'vote', 'top', 1, 0, 107),
	(106, '{"Persian":"انتقال هیرو به شهر جدید"}', 'teleport', 'side', 1, 0, 108),
	(107, '{"Persian":"ابزار ویرایش کاراکتر"}', 'character_tools', 'side', 1, 0, 109),
	(108, '{"Persian":"تبدیل تایم پلی به امتیاز"}', 'playtime', 'side', 1, 0, 110),
...
-- Dumping structure for table fusion2.pages
...
INSERT INTO `pages` (`id`, `identifier`, `name`, `content`, `rank_needed`) VALUES
	(3, 'connect', '{"Persian":"چگونه متصل شویم ؟"}', '<p style="text-align: right;">&nbsp;</p>
<p style="text-align: right;"><span style="font-size: small;">&nbsp;</span></p>
<p dir="RTL" align="right"><span style="font-size: small;"><strong>1-ابتدا شما باید از طریق<a href="../../register"> ثبت نام </a>، حساب کاربری خود را بسازید</strong></span></p>
<p style="text-align: right;"><span style="font-size: small;">&nbsp;</span></p>
<p dir="RTL"><span style="font-size: small;"><strong>2</strong><strong>-</strong><strong>بازی </strong><strong>World Of Warcraft</strong><strong> را نصب کنید. شما میتوانید بازی را از اینجا : </strong><strong><a href="https://www.worldofwarcraft.com/account/download/clients/pc/InstallWoW.exe">Windows</a></strong><strong> یا </strong><strong><a href="https://www.worldofwarcraft.com/account/download/clients/mac/InstallWoW.zip">Mac</a></strong><strong> را دانلود و نصب کنید .</strong></span></p>
<p style="text-align: right;"><span style="font-size: small;">&nbsp;</span></p>
<p dir="RTL"><span style="font-size: small;"><strong>3</strong><strong>-</strong><strong>به محل نصب بازی بروید و به مسیر </strong><strong>&ldquo;World of Warcraft\Data\enUS&rdquo;</strong><strong> رفته و سپس فایل </strong><strong>realmlist.wtf</strong><strong> را با </strong><strong>Notpad</strong><strong> بازکنید</strong><strong>.</strong></span></p>
<p style="text-align: right;">&nbsp;</p>
<p dir="RTL"><span style="font-size: small;"><strong>4</strong><strong>-</strong><strong>تمامی متن های موجود در آن را پاک کنید سپس متن زیر را وارد نمایید :</strong></span></p>
<div style="padding: 30px; display: block; font-weight: bold; text-align: right;">set realmlist logon.myserver.com</div>
<p dir="RTL" align="right"><span style="font-size: small;"><strong>درحال حاظر شما میتوانید شروع به بازی کردن کنید . اگر در حین بازی به مشکلی برخوردید به مدیریت گزارش دهید</strong>.</span></p>', 1);
...
-- Dumping structure for table fusion2.sideboxes
...
-- Dumping data for table fusion2.sideboxes: ~3 rows (approximately)
/*!40000 ALTER TABLE `sideboxes` DISABLE KEYS */;
INSERT INTO `sideboxes` (`id`, `type`, `displayName`, `rank_needed`, `order`) VALUES
	(1, 'status', '{"Persian":"وضعیت سرور"}', 1, 2),
	(2, 'info_login', '{"Persian":"اطلاعات اکانت"}', 2, 1),
	(3, 'shoutbox', '{"Persian":"جعبه پیام"}', 1, 3);
...
-- Dumping structure for table fusion2.sideboxes_poll_answers
...
-- Dumping structure for table fusion2.sideboxes_poll_questions
...
-- Dumping structure for table fusion2.sideboxes_poll_votes
...
-- ----------------------------
INSERT INTO `store_groups` VALUES ('1', 'Item Donate');
INSERT INTO `store_groups` VALUES ('2', 'Item Vote');
...
CREATE TABLE IF NOT EXISTS `chatbox` (
  ...
  `payam` varchar(1000) NOT NULL DEFAULT '',
  `esme_user` varchar(1000) NOT NULL DEFAULT '',
  `tarikh` varchar(1000) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
...
-- --------------------------------------------------------
-- Table structure for `recruit_a_friend_claimed`
-- --------------------------------------------------------

/*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */;
/*!40101 SET NAMES utf8 */;
/*!40014 SET FOREIGN_KEY_CHECKS=0 */;
CREATE TABLE IF NOT EXISTS `recruit_a_friend_claimed` (
  `recruiter` int(10) NOT NULL DEFAULT '0',
  `referral` int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (`recruiter`,`referral`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40000 ALTER TABLE `recruit_a_friend_claimed` DISABLE KEYS */;
/*!40000 ALTER TABLE `recruit_a_friend_claimed` ENABLE KEYS */;
/*!40014 SET FOREIGN_KEY_CHECKS=1 */;
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
