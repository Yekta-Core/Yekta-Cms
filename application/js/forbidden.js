...
$(document).ready(function(){
	...
	//count talk bubbles
	$("div.bubble-options p.panda-bubble").each(function(){
...
//function that handles the talking panda bubble animations
function pandaTalk(){

	var timer = setTimeout(function() {

		//change the bubble html code
		$temp = "<p>"+$("div.bubble-options p.panda-bubble:nth-child("+talkbubble+")").html()+"</p>";		
		$("div.panda-bubble").html($temp);
		...
		//show the bubble
		$(".panda-bubble").animate({"opacity":'1', "bottom":'10px'}, 400);

		//hide the bubble
		setTimeout(function() {

			$(".panda-bubble").animate({"opacity":'0', "bottom":'0px'}, 400);
			pandaTalk();	
...
//function that handles panda movement animation
function pandaRun(){
	...
	var timer2 = setTimeout(function() {
		...
		if(panda.css("background-position") == "0px 0px")
			panda.css({"background-position":"-110px 0px"});
		else if(panda.css("background-position") == "-110px 0px")
			panda.css({"background-position":"-210px 0px"});
		else
			panda.css({"background-position":"0px 0px"});	
