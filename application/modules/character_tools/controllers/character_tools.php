...
class character_tools extends MX_Controller 
{
	...
	*/
	...
	public function index()
	{
		...
		//Set the title
		$this->template->setTitle("ابزار کاربردی هیرو");
	...
	private function GetCommand($ToolId, $realmId, $CharacterName)
	{
		...
		switch ($this->tools[$ToolId])
		{
			...
			case "unstuck_change": 	return $this->GetUnstuckCommand($realmId, $CharacterName);
	...
	private function GetUnstuckCommand($realmId, $CharacterName)
	{
		switch ($this->getEmulatorString($realmId))
		{
			case "trinity":
			...
			case "mangos":
			case "mangosr2":
				return ".character unstuck " . $CharacterName;
		}
