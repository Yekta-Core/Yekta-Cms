var Theme = {
	...
	{
		$('#theme_list_text').html('<h2><img src="' + Config.URL + 'application/themes/admin/images/icons/black16x16/ic_picture.png"/> قالب ها</h2><span id="theme_ajax_spot">در حال فعال کردن قالب</span>');

		$.get(Config.URL + "admin/theme/set/" + name, function(data)
		{
			if(data == "yes")
			{
				UI.alert('قالب با موفقیت تغییر کرد', 1000);
