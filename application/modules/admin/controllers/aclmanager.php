...
class Aclmanager extends MX_Controller
{
	...
	public function index()
	{
		...
		// Output the content
		$output = $this->administrator->box("گروه های کاربری و دسترسی ها", $output);
	...
	public function groups()
	{
		...
		$output = $this->administrator->box("<a href='".pageURL."admin/aclmanager'>گروه های کاربری و دسترسی ها</a> &rarr; گروه ها", $output);
	...
	public function editGroup($id = false)
	{
		...
		if(!$group)
		{
			show_error("هیچ گروهی با این شماره وجود ندارد ".$id);
		...
		$content = $this->administrator->box('<a href="'.$this->template->page_url.'admin/aclmanager/groups">گروه ها</a> &rarr; '.$group['name'], $output);
	...
	public function groupCreate()
	{
		...
		if(!$name)
		{
			die('UI.alert("لطفا یک نام برای گروه مشخص کنید");');
		}
	...
	public function groupSave($id)
	{
		...
		die('UI.alert("گروه با موفقیت ذخیره شد")');
	}
	...
	public function roles()
	{
		...
		$output = $this->administrator->box("<a href='".pageURL."admin/aclmanager'>گروه های کاربری و دسترسی ها</a> &rarr; وظایف", $output);
	...
	public function users()
	{
		...
		$output = $this->administrator->box("<a href='".pageURL."admin/aclmanager'>گروه های کاربری و دسترسی ها</a> &rarr; دسترسی کاربران", $output);
