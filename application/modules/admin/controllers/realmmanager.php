...
class Realmmanager extends MX_Controller
{
	...
	public function edit($id = false)
	{
		...
		$content = $this->administrator->box("<a href='".$this->template->page_url."admin/settings'>تنظیمات</a> &rarr; ".$realm->getname(), $output);
