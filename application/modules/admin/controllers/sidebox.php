...
class Sidebox extends MX_Controller
{
	...
	public function index()
	{
		...
		// Change the title
		$this->administrator->setTitle("منوی کنار سایت");
		...
		$content = $this->administrator->box('منوی کنار سایت', $output);
	...
	public function edit($id = false)
	{
		...
		if(!$sidebox)
		{
			show_error("هیچ منو کناری با این شماره وجود ندارد".$id);
		...
		// Put my view in the main box with a headline
		$content = $this->administrator->box('<a href="'.$this->template->page_url.'admin/sidebox">منو کنار سایت</a> &rarr; '.langColumn($sidebox['displayName']), $output);
