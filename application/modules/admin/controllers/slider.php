...
class Slider extends MX_Controller
{
	...
	{
		// Change the title
		$this->administrator->setTitle("مدیریت اسلاید ها");
		...
		$content = $this->administrator->box('مدیریت اسلاید ها', $output);
	...
	public function edit($id = false)
	{
		...
		if(!$slide)
		{
			show_error("هیچ اسلایدی با این شماره وجود ندارد ".$id);

			die();
		}

		// Change the title
		$this->administrator->setTitle('اسلاید #'.$slide['id']);
		...
		// Put my view in the main box with a headline
		$content = $this->administrator->box('<a href="'.$this->template->page_url.'admin/slider">مدیریت اسلاید ها</a> &rarr; Slide #'.$slide['id'], $output);
	...
	public function saveSettings()
	{
		...
		die("UI.alert('تنظیمات با موفقیت ذخیره شد')");
	}
