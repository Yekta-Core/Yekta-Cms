...
class Menu extends MX_Controller 
{
	...
	public function index()
	{
		...
		$this->administrator->setTitle("لینک منو ها");
		...
		$content = $this->administrator->box('لینک منو ها', $output);
	...
	public function delete($id)
	{
		...
		{
			die("در حالی که در تلاش هستید این لینک منو را حذف کنید یک خطا رخ داده است");
		}
	...
	public function edit($id = false)
	{
		...
		if(!$link)
		{
			show_error("هیچ لینکی با این شماره وجود ندارد ".$id);
		...
		// Put my view in the main box with a headline
		$content = $this->administrator->box('<a href="'.$this->template->page_url.'admin/menu">لینم منو ها</a> &rarr; '.langColumn($link['name']), $output);
