<div class="statistics">
	<span>درآمد این ماه ({$currency})</span>
	<div class="image">
...
{if $paypal_enabled}
	<section class="box big" id="donate_articles">
		<h2>
			...
			10 تراکنش آخر پی پال
		</h2>

		<form style="margin-top:0px;" onSubmit="Donate.search('paypal'); return false">
			<input type="text" name="search_paypal" id="search_paypal" placeholder="جستجو بر ساس نام کاربری یا ایمیل پی پال" style="width:90%;margin-right:5px;"/>
...
{if $paygol_enabled}
	<section class="box big" id="donate_articles">
		<h2>
			<img src="{$url}application/themes/admin/images/icons/black16x16/ic_text_document.png"/>
			10 تراکنش آخر پای گل
		</h2>

		<form style="margin-top:0px;" onSubmit="Donate.search('paygol'); return false">
			<input type="text" name="search_paygol" id="search_paygol" placeholder="جستجو بر اساس نام کاربری یا شماره تماس" style="width:90%;margin-right:5px;"/>
			<input type="submit" value="جستجو" style="display:inline;padding:8px;" />
		</form>
