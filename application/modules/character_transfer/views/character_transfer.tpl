...
<section id="character_transfer">
    <div id="cta_description" class="style1">{$cta_lang.DESCRIPTION}</div>
    ...
    <div id="cta_body">
        ...
        <div class="cta_body_left">
            ...
            <div class="style1" {if $realm.id != $first_realm.id}style="display: none;"{else}id="cta_visible_char_select"{/if}>
        ...
        <div class="cta_body_right">
            <form onsubmit="CharacterTransfer.Submit(); return false;">
                ...
                <div class="cta_row">
                    <p class="style1">{$cta_lang.COST_EXPL}</p>
                </div>
