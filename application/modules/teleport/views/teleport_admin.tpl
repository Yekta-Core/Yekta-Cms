<section class="box big" id="main_teleport">
	<h2>
		...
		مدیریت تلپورت (<div style="display:inline;" id="teleport_count">{if !$teleport_locations}0{else}{count($teleport_locations)}{/if}</div>)
	</h2>

	{if hasPermission("canAdd")}
		<span>
			<a class="nice_button" href="javascript:void(0)" onClick="Teleport.add()">ایجاد موقیت جدید تلپورت</a>
		</span>
	{/if}
