...
class Admin extends MX_Controller
{
	...
	{
		// Change the title
		$this->administrator->setTitle("سایت های رتبه بندی");
		...
		$content = $this->administrator->box('سایت های رتبه بندی', $output);
	...
	public function edit($id = false)
	{
		...
		if(!$topsite)
		{
			show_error("هیچ سایت با ID وجود دارد ".$id);
		...
		// Put my view in the main box with a headline
		$content = $this->administrator->box('<a href="'.$this->template->page_url.'vote/admin">سایت های رتبه بندی</a> &rarr; '.$topsite['vote_sitename'], $output);
