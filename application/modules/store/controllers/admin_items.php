...
class Admin_items extends MX_Controller
{
	...
	{
		// Change the title
		$this->administrator->setTitle("آیتم ها");
		...
		$content = $this->administrator->box('فروشگاه', $output);
	...
	public function createGroup()
	{
		...
		if(!$data['title'])
		{
			die("UI.alert('فیلد نمی تواند خالی باشد')");
		}
		...
		// Add log
		$this->logger->createLog('اضافه شده گروه آیتم', $data["title"]);
	...
	public function create()
	{
		...
		// Add log
		$this->logger->createLog('آیتم اضافه شده', $data['name']);
	...
	private function getItemData()
	{
		...
		{
			die("UI.alert('آی دی آیتم نامعتبر است')");
		}
	...
	public function edit($id = false)
	{
		...
		if(!$item)
		{
			show_error("هیچ آیتم با این آی دی وجود دارد");
	...
	public function save($id = false)
	{
		...
		// Add log
		$this->logger->createLog('آیتم ویرایش شده', $data['name']);
	...
	public function saveGroup($id = false)
	{
		...
		// Add log
		$this->logger->createLog('گروه آیتم ویرایش شده', $id);
	...
	public function delete($id = false)
	{
		...
		// Add log
		$this->logger->createLog('آیتم حذف شده', $id);
	...
	public function deleteGroup($id = false)
	{
		...
		// Add log
		$this->logger->createLog('گروه حذف شده', $id);
